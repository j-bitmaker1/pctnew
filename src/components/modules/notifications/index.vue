...
<div id="notifications">
	...
	<listpaginated :placeholder="placeholder" @count="setcount" :select="{context : 'notifications'}" api="notifications.list" :payload="payload" :start="0" from="pageNumber" to="pageSize" ref="list" transition="list" :bypages="true">
